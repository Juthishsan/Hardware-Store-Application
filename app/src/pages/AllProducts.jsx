...
const AllProducts = () => {
    ...
    useEffect(() => {
        handleSearch(searchText, selectedType);
        ...
        const fetchData = async () => {
            try {
                ...
                if (snapshot.exists()) {
                    ...
                    const dataEntries = Object.entries(dataObject).map(([key, value]) => ({
                        key,
                        ...value
                    }));
    ...
    return (
        <div>
            <section id="Featured" className="my-3">
                            ...
                            <div className="col-md-8">
                                <div className="input-group search-bar">
                                    <input
                                        ...
                                        className="form-control py-2 border-end-0 rounded-start"
                                        value={searchText}
                                        onChange={(e) => {
                                    ...
                                    />
                                    <span className="input-group-text bg-white border-start-0"><i className="bi bi-search"></i></span>
                                </div>
                            </div>
                            <div className="col-md-4 mt-3 mt-md-0">
                                <div className="input-group filter-dropdown">
                                    <select
                                        value={selectedType}
                                        onChange={(e) => {
                                    ...
                                    <label className="input-group-text bg-white border-start-0"><i className="bi bi-filter"></i></label>
                                </div>
                            </div>
                        </div>
                    </div>
