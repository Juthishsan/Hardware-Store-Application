...
const ProductInfo = ({ productType }) => {
    ...
    useEffect(() => {
        if (modalProduct) {
            const newTotalPrice = modalProduct.price * quantity;
        ...
        <div>
            <section id="Featured" className="my-5 pb-5">
                <div className="row mx-auto container-fluid">
                    {tableData.map((entry) => (
                        <div className="product text-center col-lg-3 col-md-4 col-sm-6 col-6" key={entry.key}>
                            ...
                            <h4 className="p-price pt-3">{`₹ ${entry.price} `} {entry.type === "Pipes" ? "/Meter" : ""}</h4>
                            <br />
            ...
            {bigmodal && modalProduct && (
                <div>
                    <div className="modal d-block border-0" role="dialog" style={{ display: 'block', background: 'rgba(0, 0, 0, 0.5)', backdropFilter: 'blur(5px)' }}>
                            ...
                            <div className="modal-content text-bg-green border-0 rounded-4">
                                <div className="modal-body" >
                                    <div className='d-flex flex-row justify-content-between pb-3'>
                                        <h3 className='animate__animated animate__fadeInDown text-center fw-bold'>Product Info</h3>
                                            ...
                                            <section className="sproduct container mb-3 ">
                                                <div className="row mt-5">
                                                    ...
                                                    <div className="col-lg-6 col-md-12 col-12">
                                                        ...
                                                        <div className='d-flex flex-row justify-content-between mt-3 text-justify'>
                                                            <h3> {modalProduct.name}</h3>
                                                        </div>

                                                        <div className='row my-2 pt-5'>
                                                            <div className='col'>
                                                                <h2>₹ {totalPrice} {modalProduct.type === "Wires" ? "" : "/Meter"}</h2>
                                                            </div>
                                                            <div className='col d-flex flex-column justify-content-end align-items-end'>
                                                                <div className="quantity-selector">
                                                                    <button className="quantity-btn" onClick={decrementQuantity}><i className="fas fa-minus" style={{ color: 'black' }}></i></button>
                                                                    <input className="quantity-input" type="number" value={quantity} readOnly />
                                                                    <button className="quantity-btn" onClick={incrementQuantity}><i className="fas fa-plus" style={{ color: 'black' }}></i></button>
                                                                </div>
                                                                <div>
